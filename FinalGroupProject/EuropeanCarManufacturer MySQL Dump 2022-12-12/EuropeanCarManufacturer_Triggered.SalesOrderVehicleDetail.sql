...
--
-- Table structure for table `Triggered.SalesOrderVehicleDetail`
--

DROP TABLE IF EXISTS `Triggered.SalesOrderVehicleDetail`;
...
CREATE TABLE `Triggered.SalesOrderVehicleDetail` (
  ...
  KEY `FK_SalesOrderVehicleDetail_SalesOrderVehicle` (`SalesOrderVehicleId`),
  CONSTRAINT `FK_SalesOrderVehicleDetail_SalesOrderVehicle` FOREIGN KEY (`SalesOrderVehicleId`) REFERENCES `Sales.SalesOrderVehicle` (`SalesOrderVehicleId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Triggered.SalesOrderVehicleDetail`
--

LOCK TABLES `Triggered.SalesOrderVehicleDetail` WRITE;
/*!40000 ALTER TABLE `Triggered.SalesOrderVehicleDetail` DISABLE KEYS */;
/*!40000 ALTER TABLE `Triggered.SalesOrderVehicleDetail` ENABLE KEYS */;
UNLOCK TABLES;
