...
--
-- Table structure for table `Triggered.Country`
--

DROP TABLE IF EXISTS `Triggered.Country`;
...
--
-- Dumping data for table `Triggered.Country`
--

LOCK TABLES `Triggered.Country` WRITE;
/*!40000 ALTER TABLE `Triggered.Country` DISABLE KEYS */;
/*!40000 ALTER TABLE `Triggered.Country` ENABLE KEYS */;
UNLOCK TABLES;
