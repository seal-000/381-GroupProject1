...
--
-- Table structure for table `Triggered.ManufacturerModel`
--

DROP TABLE IF EXISTS `Triggered.ManufacturerModel`;
...
--
-- Dumping data for table `Triggered.ManufacturerModel`
--

LOCK TABLES `Triggered.ManufacturerModel` WRITE;
/*!40000 ALTER TABLE `Triggered.ManufacturerModel` DISABLE KEYS */;
/*!40000 ALTER TABLE `Triggered.ManufacturerModel` ENABLE KEYS */;
UNLOCK TABLES;
