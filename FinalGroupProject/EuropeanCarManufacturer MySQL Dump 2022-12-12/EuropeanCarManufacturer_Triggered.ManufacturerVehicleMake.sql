...
--
-- Table structure for table `Triggered.ManufacturerVehicleMake`
--

DROP TABLE IF EXISTS `Triggered.ManufacturerVehicleMake`;
...
--
-- Dumping data for table `Triggered.ManufacturerVehicleMake`
--

LOCK TABLES `Triggered.ManufacturerVehicleMake` WRITE;
/*!40000 ALTER TABLE `Triggered.ManufacturerVehicleMake` DISABLE KEYS */;
/*!40000 ALTER TABLE `Triggered.ManufacturerVehicleMake` ENABLE KEYS */;
UNLOCK TABLES;
