...
--
-- Table structure for table `Triggered.Staff`
--

DROP TABLE IF EXISTS `Triggered.Staff`;
...
--
-- Dumping data for table `Triggered.Staff`
--

LOCK TABLES `Triggered.Staff` WRITE;
/*!40000 ALTER TABLE `Triggered.Staff` DISABLE KEYS */;
/*!40000 ALTER TABLE `Triggered.Staff` ENABLE KEYS */;
UNLOCK TABLES;
