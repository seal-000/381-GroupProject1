...
CREATE TABLE [CaterySalesThresholdLookupTable]
( 
	[LowerThreshold]     int  NULL ,
	[UpperThreshold]     int  NULL ,
	[CateryDescription] nvarchar(4000)  NULL 
)
...
( 
	...
	[Sys_Start_Time]     Datetime2(7)  NULL ,
	[Sys_End_Time]       Datetime2(7)  NULL 
)
...
( 
	...
	[CountryISO3]        char(3) COLLATE SQL_Latin1_General_CP1_CI_AS  NOT NULL ,
	[CountryName]        nvarchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL ,
	[CountryISO2]        char(2) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL ,
...
( 
	...
	[CustomerTown]       nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL ,
	[CustomerPostalCode] nvarchar(10) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL ,
	[CustomerCountry]    char(2) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL ,
	[IsCustomeReseller]  bit  NULL ,
	[IsCustomerCreditRisk] bit  NULL ,
	[CustomerSpendCapacityId] int  NULL 
)
...
( 
	...
	[CustomerTown]       nvarchar(50)  NULL ,
	[CustomerCountry]    char(2)  NULL ,
	[IsCustomerReseller] bit  NULL 
	CONSTRAINT [DF_Template_Flag1_809802701]
		 DEFAULT  1,
	[IsCostumerCreditRisk] bit  NULL 
...
( 
	...
	[IndividualProject]  nvarchar(30)  NULL ,
...
( 
	[ManufacturerModelId] int  IDENTITY ( 1,1 )  NOT NULL ,
	[ManufacturerModelName] nvarchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL ,
	[ManufacturerModelVariant] char(3) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL ,
	[ManufacturerVehicleStockId] int  NOT NULL 
)
...
( 
	[ManufacturerVehicleMakeId] int  IDENTITY ( 1,1 )  NOT NULL ,
	[ManufacturerVehicleMakeName] nvarchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL ,
	[ManufacturerVehicleMakeCountry] char(3) COLLATE SQL_Latin1_General_CP1_CI_AS  NOT NULL ,
	[MarketingTypeId]    int  NULL 
)
...
( 
	...
	CONSTRAINT [DF_Template_Flag1_1531184495]
		 DEFAULT  1,
	[VehicleColor]       nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL ,
...
CREATE TABLE [Marketing].[MarketingCatery]
( 
...
CREATE TABLE [MarketingCateryLookupTable]
( 
	[MarketingTypeId]    nvarchar(200)  NOT NULL ,
...
( 
	...
	[SpendCapacity]      numeric(18,2)  NOT NULL 
...
( 
	[CustomerSpendCapacityId] numeric(18,2)  NOT NULL ,
	[CustomerName]       int  NULL ,
	[Country]            char(2)  NULL 
)


CREATE TABLE [Sales].[SalesCateryThreshold]
( 
	[LowerThreshold]     int  NULL ,
	[UpperThreshold]     int  NULL ,
	[CateryDescription] nvarchar(4000) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL 
)


CREATE TABLE [Sales].[SalesOrderVehicle]
( 
	[SalesOrderVehicleId] int  IDENTITY ( 1,1 )  NOT NULL ,
	[CustomerId]         int  NULL ,
	[StaffId]            int  NOT NULL ,
	[InvoiceNumber]      nchar(8) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL ,
	[TotalSalePrice]     numeric(18,2)  NULL ,
	[SaleDate]           date  NULL ,
	[CateryDescription] AS ('Create computed column based upon the SalesCateryThreshold Table') COLLATE SQL_Latin1_General_CP1_CI_AS PERSISTED NOT NULL 
)


CREATE TABLE [Sales].[SalesOrderVehicleDetail]
( 
	[SalesOrderVehicleDetailId] int  IDENTITY ( 1,1 )  NOT NULL ,
...
( 
	...
	[StaffName]          nvarchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL ,
	[ManagerID]          int  NULL ,
...
ALTER TABLE [MarketingCateryLookupTable]
	ADD CONSTRAINT [XPKMarketingCateryLookup] PRIMARY KEY  CLUSTERED ([MarketingTypeId] ASC)
...
CREATE VIEW [SalesOrderDetailNames]([CustomerName],[StaffName],[InvoiceNumber],[TotalSalePrice],[SaleDate],[SalesOrderVehicleId])
AS
SELECT [Customer].[CustomerName],[Staff].[StaffName],[SalesOrderVehicle].[InvoiceNumber],[SalesOrderVehicle].[TotalSalePrice],[SalesOrderVehicle].[SaleDate],[SalesOrderVehicle].[SalesOrderVehicleId]
...
CREATE VIEW [VehicleMakeCountry]([CountryISO3],[ManufacturerVehicleMakeName],[ManufacturerVehicleMakeCountry],[ManufacturerVehicleMakeId])
AS
SELECT [Country].[CountryISO3],[ManufacturerVehicleMake].[ManufacturerVehicleMakeName],[ManufacturerVehicleMake].[ManufacturerVehicleMakeCountry],[ManufacturerVehicleMake].[ManufacturerVehicleMakeId]
...
CREATE VIEW [StaffSales]([StaffId],[StaffName],[TotalSalePrice])
AS
SELECT ALL [Staff].[StaffId],[Staff].[StaffName],[SalesOrderVehicle].[TotalSalePrice]
	FROM [Employee].[Staff],[Sales].[SalesOrderVehicle]
		WHERE [Employee].[Staff].[StaffId] = [Sales].[SalesOrderVehicle].[StaffId]
		GROUP BY [Staff].[StaffId]


CREATE VIEW [CustomerSales]([CustomerId],[CustomerName],[SalesOrderVehicleId],[StockId],[Cost],[SalePrice],[TotalSalePrice],[SaleDate])
AS
SELECT DISTINCT [Customer].[CustomerId],[Customer].[CustomerName],[SalesOrderVehicle].[SalesOrderVehicleId],[SalesOrderVehicleDetail].[StockId],[ManufacturerVehicleStock].[Cost],[SalesOrderVehicleDetail].[SalePrice],[SalesOrderVehicle].[TotalSalePrice],[SalesOrderVehicle].[SaleDate]
	FROM [SalesOrderVehicleDetail],[Customer],[ManufacturerVehicleStock],[SalesOrderVehicle]
...
ALTER TABLE [Manufacturer].[ManufacturerModel]
	ADD CONSTRAINT [R_6] FOREIGN KEY ([ManufacturerVehicleStockId]) REFERENCES [ManufacturerVehicleStock]([ManufacturerVehicleStockId])



ALTER TABLE [Marketing].[MarketingInformation]
	ADD CONSTRAINT [FK_MarketingInformation_Customer] FOREIGN KEY ([CustomerId]) REFERENCES [Customer].[Customer]([CustomerId])
...
ALTER TABLE [Sales].[SalesOrderVehicle]
	ADD CONSTRAINT [FK_SalesOrderVehicle_Staff] FOREIGN KEY ([StaffId]) REFERENCES [Employee].[Staff]([StaffId])
...
CREATE FUNCTION [DatabaseObjects] (@ListOfObjectIDs varchar(max) )  
  RETURNS TABLE
...
BEGIN
  DECLARE  @numrows int,
           @nullcnt int,
           @validcnt int,
           @insManufacturerModelId Id, 
           @insManufacturerVehicleStockId Id,
           @errno   int,
           @severity int,
           @state    int,
           @errmsg  varchar(255)
...
BEGIN
  DECLARE  @numrows int,
           @nullcnt int,
           @validcnt int,
           @insSalesOrderVehicleDetailId Id,
           @errno   int,
           @severity int,
           @state    int,
           @errmsg  varchar(255)
